...
public class RobotContainer {
   ...
   */ 
    ...
    new Trigger(() -> m_driverController.getRawAxis(DriveConstants.k_spinUpTrigger) > 0.05)
      .whileTrue(
        new InstantCommand(() -> {
          m_shooterSubystem.spinUp();
          if(m_shooterSubystem.getShooterMotorSpeed()>ShooterConstants.k_shooterSpeedThreshold){
    ...
    new Trigger(() -> m_driverController.getRawAxis(DriveConstants.k_shootTrigger) > 0.05)
      ...
      .whileFalse(
        new InstantCommand(() -> m_shooterSubystem.stopIndex(), m_shooterSubystem)
      );
